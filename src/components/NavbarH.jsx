...
senddata(setData(['Search',fil]))
  ...
  return (
    <div className="row bg-dark fixed-top me-0 ms-0 border  pb-1">
        ...
        </div> : <div onClick={()=>{moveProduct('/addcard')}} className='col-2 pe-3 col-md-1 d-lg-none col-sm-2 col-lg-1 mt-lg-1 mb-lg-1 order-lg-5 ps-0 justify-content-center  order-5 mt-1  d-flex align-items-center text-white'><i style={{fontSize:'20px'}} className="text-white fas fa-shopping-cart"></i></div> }
